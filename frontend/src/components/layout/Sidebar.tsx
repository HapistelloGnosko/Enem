...
export function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed md:static inset-y-0 left-0 z-50 w-72 md:w-64 min-h-screen bg-bg-secondary border-r border-white/5 flex flex-col justify-between shrink-0 p-4 transition-transform duration-200 ease-out overflow-y-auto
